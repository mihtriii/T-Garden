  ...
  return (
    ...
    <div className="TG_Login"> 
        <div className="TG_Login_Left">
            <img className="TG_Login_Left_Background" src="./img/Start_background.jpg"/>
        </div>
        ...
        <div className="TG_Login_Right">
            ...
            <div className="TG_Login_Right_Enterusername">
                ...
                <div className="TG_Login_Right_Enterusername_container">
                  <input className="TG_Login_Right_Enterusername_container_input"
                      type="text"
                      placeholder="Username"
                  />
                  <div className="TG_Login_Right_Enterusername_container_underline"div/>
                </div>
            </div>
            ...
            <div className="TG_Login_Right_Enterpassword">
                ...
                <div className="TG_Login_Right_Enterpassword_container">
                  <input className="TG_Login_Right_Enterpassword_container_input"
                      type="text"
                      placeholder="Password"
                  />
                  <div className="TG_Login_Right_Enterpassword_container_underline"div/>
                </div>
                <button onClick={revealpasswordButton}>
                  {setrevealpassword ? <IoIosEye size={25}/> : <IoIosEyeOff size={25}/>}
                </button>     
            </div>
            <div button onClick={ForgotPWButton} className="TG_Login_Right_Forgotpassword">
              Forgot Password? 
            </div>
            <div className="TG_Login_Right_Rememberme">
              <input className="TG_Login_Right_Rememberme_checkbox" type="checkbox" id="myCheck"/>
              <div className="TG_Login_Right_Rememberme_text" >Remember me </div>
            </div>
            <button className="TG_Login_Right_Enter" iconClick={EnterButton}>
              Enter
            </button>
